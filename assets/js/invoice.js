...
$(function () {
    ...
    let InvoiceApp = {
        handleDetailsLinkAdd: function (e) {
            ...
            let $element = $(element);
            $element.find('a.js-detail-copy').on('click', InvoiceApp.handleDetailsLinkCopy);
        ...
        initialize: function ($detailsContainer, $detailsLinkAdd) {
            ...
            this.$detailsContainer.find('a.js-detail-copy').on('click', this.handleDetailsLinkCopy);
